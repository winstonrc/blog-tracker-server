describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    beforeEach(function() {
      ...
      cy.createBlog({ title: 'cypress-test-blog', author: 'cypress', url: 'www.docs.cypress.io', likes: 0 })
    })
  ...
  describe('When there are multiple blogs', function() {
    beforeEach(function() {
      cy.login({ username: 'test-user', password: 'salainen' })
      cy.createBlog({ title: 'cypress-test-blog-1', author: 'cypress', url: 'www.docs.cypress.io', likes: 0 })
      cy.createBlog({ title: 'cypress-test-blog-2', author: 'cypress', url: 'www.docs.cypress.io', likes: 1 })
      cy.createBlog({ title: 'cypress-test-blog-3', author: 'cypress', url: 'www.docs.cypress.io', likes: 2 })
    })
